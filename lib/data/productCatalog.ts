...
export const productCatalog: ProductCategory[] = [
  ...
  },
  {
    ...
    supplier: "Battery Based System",
    variants: [
      {
        name: "Standard Off-Grid Bundles",
        description: "Standalone systems with battery storage for complete independence.",
        products: [
          { kWp: 3.00, phase: 1, module: 580, qty: 5, price: 220000, wire: 150, outOfVns: 5000, isOffGrid: true },
          { kWp: 5.00, phase: 1, module: 580, qty: 9, price: 320000, wire: 150, outOfVns: 5000, isOffGrid: true },
        ],
      },
    ],
  },
  {
    category: "VFD / Solar Pumps",
    supplier: "Solar Pump Drives",
    variants: [
      {
        name: "INVT / Crompton Drives",
        description: "Solar Variable Frequency Drives for water pumping.",
        products: [
          { kWp: 10, phase: 3, module: 600, qty: 16, price: 250000, wire: 150, outOfVns: 5000, isVFD: true, customLabel: "10 HP VFD" },
          { kWp: 25, phase: 3, module: 600, qty: 40, price: 450000, wire: 150, outOfVns: 5000, isVFD: true, customLabel: "25 HP VFD" },
        ],
      },
    ],
  },
  {
    category: "Services & O&M",
    supplier: "Operations & Maintenance",
    variants: [
      {
        name: "Annual Maintenance Contracts",
        description: "Comprehensive operation, maintenance, and cleaning services.",
        products: [
          { kWp: 0, phase: 1, module: 0, qty: 1, price: 320000, wire: 0, outOfVns: 0, isService: true, customLabel: "O&M Service - 1 Year" },
        ],
      },
    ],
  },
